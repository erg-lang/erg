...
impl Context {
    ...
    fn supertype_of_tp(&self, lp: &TyParam, rp: &TyParam, variance: Variance) -> bool {
        ...
        match (lp, rp, variance) {
            ...
            (TyParam::Type(l), TyParam::Type(r), Contravariant) => self.subtype_of(l, r),
            (TyParam::Type(l), TyParam::Type(r), Covariant) => self.supertype_of(l, r),
            (TyParam::Type(l), TyParam::Type(r), Invariant) => self.same_type_of(l, r),
            (
