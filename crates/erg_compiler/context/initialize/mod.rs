...
const FUNC_FROMKEYS: &str = "fromkeys";
...
const FUNC_POPITEM: &str = "popitem";
const PROC_POPITEM: &str = "popitem!";
const FUNC_SETDEFAULT: &str = "setdefault";
const PROC_SETDEFAULT: &str = "setdefault!";
...
const KW_ARG1: &str = "arg1";
const KW_ARG2: &str = "arg2";
...
const KW_FROMLIST: &str = "fromlist";
const KW_LEVEL: &str = "level";
