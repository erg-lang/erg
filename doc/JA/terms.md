...
2022年に発表された静的型付けプログラミング言語であり、本ドキュメントで解説される対象である。開発者は「エルグ」(`/ɝ́rug/`, 日本語での発音[(Google Translate)](https://translate.google.com/?sl=ja&tl=en&text=%E3%82%A8%E3%83%AB%E3%82%B0))と発音している。命名の由来はCGS単位系におけるエネルギーの単位である。`/ɝ́rug/`()
