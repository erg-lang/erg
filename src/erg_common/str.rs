...
impl From<&'static str> for Str {
    #[inline]
    fn from(s: &'static str) -> Self { Str::ever(s) }
}

impl From<&String> for Str {
    #[inline]
    fn from(s: &String) -> Self { Str::Rc((&s[..]).into()) }
}
...
impl From<&RcStr> for Str {
    #[inline]
    fn from(s: &RcStr) -> Self { Str::Rc(s.clone()) }
}

impl From<RcStr> for Str {
    #[inline]
    fn from(s: RcStr) -> Self { Str::Rc(s) }
}
...
impl Str {
    pub const fn ever(s: &'static str) -> Self { Str::Static(s) }

    pub fn rc(s: &str) -> Self { Str::Rc(s.into()) }

    pub fn as_ref(&self) -> &str { self.borrow() }
